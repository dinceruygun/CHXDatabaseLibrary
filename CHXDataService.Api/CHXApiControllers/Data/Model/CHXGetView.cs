...
{
    public class CHXGetView : CHXDataApi, ICHXDataApiModel
    {
        public CHXGetView(ClaimsPrincipal principal) : base(principal)
        {
        ...
        public override object Call(CHXRequest data, string method)
        {
            ...
            var tableName = data.Find("viewname");
            ...
            var resultData = myDatabase.Database.Views.Where(d => d.SchemaName == schemaName.Value.ToString() && d.TableName == tableName.Value.ToString()).Select(d =>
            new
            {
