...
namespace CHXDatabaseLibrary.DatabaseCommands.PostgreSql
{
    public class PostgreSql : ICHXDatabaseCommand
    {
        public PostgreSql(CHXDatabase database) : base(database)
        {
